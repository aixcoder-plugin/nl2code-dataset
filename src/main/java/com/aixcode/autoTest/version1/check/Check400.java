...
import com.aixcode.autoTest.version1.aixcoder.Aixcoder400;
import com.aixcode.autoTest.version1.copilot.Copilot400;

import java.util.ArrayList;
import java.util.List;

public class Check400 extends BaseAbstractTest {
    ...
    public int[] checkCopilot() {
        Copilot400 solution=new Copilot400();
        int passCount=0;
    ...
    public int[] checkAixcoder() {
        Aixcoder400 solution=new Aixcoder400();
        int passCount=0;
        for (int i=0;i<strList.size();i++){
            String str1=strList.get(i);
            String str2=strList2.get(i);
